...
###############################################################################
# build_oe4t_jetson_multi_platform_v65.sh
#
...
# Build one platform:
#   ./build_oe4t_jetson_multi_platform_v65.sh
#   TARGET_PLATFORM=orin-nx ./build_oe4t_jetson_multi_platform_v65.sh
#   TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_platform_v65.sh
#
# Build all three platforms:
#   BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_platform_v65.sh
#
# Smaller image:
#   TARGET_IMAGE=demo-image-base ./build_oe4t_jetson_multi_platform_v65.sh
#
# Clean one platform build directory:
#   CLEAN_BUILD=1 ./build_oe4t_jetson_multi_platform_v65.sh
#
# Production-ish build without permissive dev login:
#   DEV_LOGIN_FEATURES=0 ./build_oe4t_jetson_multi_platform_v65.sh
#
# Bundle primary tegraflash artifact after a successful build:
#   ./build_oe4t_jetson_multi_platform_v65.sh --bundle
#
# Important:
...
Examples:
  ...
  BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_platform_v65.sh
  ./build_oe4t_jetson_multi_platform_v65.sh --bundle
  TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_platform_v65.sh --bundle
...
# BEGIN generated by build_oe4t_jetson_multi_platform_v65.sh thor cuda overlap guard
...
# END generated by build_oe4t_jetson_multi_platform_v65.sh thor cuda overlap guard
EOF_THOR_CUDA_CONF
    fi
...
# Generated by build_oe4t_jetson_multi_platform_v65.sh.
...
# Local fixes generated by build_oe4t_jetson_multi_platform_v65.sh.
BBPATH .= ":\${LAYERDIR}"
...
EOF_TEGRA_FLASHTOOLS_NATIVE
    ...
    if [ "$has_tegra_flashtools_base" != "1" ] && [ "$has_tegra_flashtools_native" != "1" ]; then
        ...
        log "Skipping tegra-flashtools mkbootimg wrapper for $platform; no matching recipe exists on this OE4T branch."
    fi
}
...
clean_tegra_flashtools_state_if_needed() {
    ...
    [ "$platform" = "thor" ] || return 0
    local fix_layer="$distro_dir/layers/meta-jetson-builder-fixes"
    clean_recipe_state_if_fix_changed "$build_abs_dir" "tegra-flashtools-mkbootimg-wrapper-clean-v65" "tegra-flashtools-native" \
        ...
        "$fix_layer/recipes-bsp/tegra-flashtools/files/mkbootimg-wrapper"
    if [ -d "$build_abs_dir/tmp/sysroots-components" ]; then

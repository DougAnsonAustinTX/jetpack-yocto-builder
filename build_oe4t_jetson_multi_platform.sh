...
###############################################################################
# build_oe4t_jetson_multi_platform_v20.sh
#
...
# Build one platform:
#   ./build_oe4t_jetson_multi_platform_v20.sh
#   TARGET_PLATFORM=orin-nx ./build_oe4t_jetson_multi_platform_v20.sh
#   TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_platform_v20.sh
#
# Build all three platforms:
#   BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_platform_v20.sh
#
# Smaller image:
#   TARGET_IMAGE=demo-image-base ./build_oe4t_jetson_multi_platform_v20.sh
#
# Clean one platform build directory:
#   CLEAN_BUILD=1 ./build_oe4t_jetson_multi_platform_v20.sh
#
# Production-ish build without permissive dev login:
#   DEV_LOGIN_FEATURES=0 ./build_oe4t_jetson_multi_platform_v20.sh
#
# Important:
...
# Local fixes generated by build_oe4t_jetson_multi_platform_v20.sh.
...
#
# Keep wrapper shell code in file://mkbootimg-wrapper rather than embedding it
...
SRC_URI:append = " file://mkbootimg-wrapper"
...
do_install:append() {
    ...
    install -m 0755 "${WORKDIR}/mkbootimg-wrapper" "$mkbootimg_path"

...
###############################################################################
# build_oe4t_jetson_multi_platform_v24.sh
#
...
# Build one platform:
#   ./build_oe4t_jetson_multi_platform_v24.sh
#   TARGET_PLATFORM=orin-nx ./build_oe4t_jetson_multi_platform_v24.sh
#   TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_platform_v24.sh
#
# Build all three platforms:
#   BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_platform_v24.sh
#
# Smaller image:
#   TARGET_IMAGE=demo-image-base ./build_oe4t_jetson_multi_platform_v24.sh
#
# Clean one platform build directory:
#   CLEAN_BUILD=1 ./build_oe4t_jetson_multi_platform_v24.sh
#
# Production-ish build without permissive dev login:
#   DEV_LOGIN_FEATURES=0 ./build_oe4t_jetson_multi_platform_v24.sh
#
# Important:
...
# Local fixes generated by build_oe4t_jetson_multi_platform_v24.sh.
...
# of the headers.
PR:append = ".jetsonbuilder24"

do_install:append() {
    cuda_root="${D}${prefix}/local/cuda-${CUDA_VERSION}"

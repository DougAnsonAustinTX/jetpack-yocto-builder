...
###############################################################################
# build_oe4t_jetson_multi_platform_v40.sh
#
...
# Build one platform:
#   ./build_oe4t_jetson_multi_platform_v40.sh
#   TARGET_PLATFORM=orin-nx ./build_oe4t_jetson_multi_platform_v40.sh
#   TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_platform_v40.sh
#
# Build all three platforms:
#   BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_platform_v40.sh
#
# Smaller image:
#   TARGET_IMAGE=demo-image-base ./build_oe4t_jetson_multi_platform_v40.sh
#
# Clean one platform build directory:
#   CLEAN_BUILD=1 ./build_oe4t_jetson_multi_platform_v40.sh
#
# Production-ish build without permissive dev login:
#   DEV_LOGIN_FEATURES=0 ./build_oe4t_jetson_multi_platform_v40.sh
#
# Important:
...
# BEGIN generated by build_oe4t_jetson_multi_platform_v40.sh thor cuda overlap guard
...
# END generated by build_oe4t_jetson_multi_platform_v40.sh thor cuda overlap guard
EOF_THOR_CUDA_CONF
    fi
...
# Generated by build_oe4t_jetson_multi_platform_v40.sh.
...
# Local fixes generated by build_oe4t_jetson_multi_platform_v40.sh.
BBPATH .= ":\${LAYERDIR}"

...
###############################################################################
# build_oe4t_jetson_multi_platform_v17.sh
#
...
# Build one platform:
#   ./build_oe4t_jetson_multi_platform_v17.sh
#   TARGET_PLATFORM=orin-nx ./build_oe4t_jetson_multi_platform_v17.sh
#   TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_platform_v17.sh
#
# Build all three platforms:
#   BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_platform_v17.sh
#
# Smaller image:
#   TARGET_IMAGE=demo-image-base ./build_oe4t_jetson_multi_platform_v17.sh
#
# Clean one platform build directory:
#   CLEAN_BUILD=1 ./build_oe4t_jetson_multi_platform_v17.sh
#
# Production-ish build without permissive dev login:
#   DEV_LOGIN_FEATURES=0 ./build_oe4t_jetson_multi_platform_v17.sh
#
# Important:
...
# Local fixes generated by build_oe4t_jetson_multi_platform_v17.sh.
...
case "$magic" in
    ...
    *"ELF"*"ARM"*)
        ...
        ;;
    *)
        # Unknown file(1) output or unusual NVIDIA payload. Try direct first,
        # then the common qemu user-mode interpreters.
        try_direct "$@" || true

...
###############################################################################
# build_oe4t_jetson_multi_platform_v58.sh
#
...
# Build one platform:
#   ./build_oe4t_jetson_multi_platform_v58.sh
#   TARGET_PLATFORM=orin-nx ./build_oe4t_jetson_multi_platform_v58.sh
#   TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_platform_v58.sh
#
# Build all three platforms:
#   BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_platform_v58.sh
#
# Smaller image:
#   TARGET_IMAGE=demo-image-base ./build_oe4t_jetson_multi_platform_v58.sh
#
# Clean one platform build directory:
#   CLEAN_BUILD=1 ./build_oe4t_jetson_multi_platform_v58.sh
#
# Production-ish build without permissive dev login:
#   DEV_LOGIN_FEATURES=0 ./build_oe4t_jetson_multi_platform_v58.sh
#
# Bundle primary tegraflash artifact after a successful build:
#   ./build_oe4t_jetson_multi_platform_v58.sh --bundle
#
# Important:
...
#
# v58 notes:
#   - Adds an all-platform hwloc guard for Orin Nano Super, Orin NX, and Thor:
...
Examples:
  ...
  BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_platform_v58.sh
  ./build_oe4t_jetson_multi_platform_v58.sh --bundle
  TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_platform_v58.sh --bundle
...
# BEGIN generated by build_oe4t_jetson_multi_platform_v58.sh thor cuda overlap guard
...
# END generated by build_oe4t_jetson_multi_platform_v58.sh thor cuda overlap guard
EOF_THOR_CUDA_CONF
    fi
...
# Generated by build_oe4t_jetson_multi_platform_v58.sh.
...
# Local fixes generated by build_oe4t_jetson_multi_platform_v58.sh.
BBPATH .= ":\${LAYERDIR}"

...
# Build one platform:
#   ./build_oe4t_jetson_multi_v11.sh
#   TARGET_PLATFORM=orin-nx ./build_oe4t_jetson_multi_v11.sh
#   TARGET_PLATFORM=thor ./build_oe4t_jetson_multi_v11.sh
#
# Build all three platforms:
#   BUILD_ALL_PLATFORMS=1 ./build_oe4t_jetson_multi_v11.sh
#
# Smaller image:
#   TARGET_IMAGE=demo-image-base ./build_oe4t_jetson_multi_v11.sh
#
# Clean one platform build directory:
#   CLEAN_BUILD=1 ./build_oe4t_jetson_multi_v11.sh
#
# Production-ish build without permissive dev login:
#   DEV_LOGIN_FEATURES=0 ./build_oe4t_jetson_multi_v11.sh
#
# Important:
...
# BEGIN generated by build_oe4t_jetson_multi_v11.sh
...
# END generated by build_oe4t_jetson_multi_v11.sh
EOF

    if [ "$DEV_LOGIN_FEATURES" = "1" ]; then
        cat >> "$file" <<EOF

# BEGIN generated by build_oe4t_jetson_multi_v11.sh dev login
...
# END generated by build_oe4t_jetson_multi_v11.sh dev login
EOF
    else
        cat >> "$file" <<EOF
...
# Local fixes generated by build_oe4t_jetson_multi_platform_v11.sh.
...
LAYERSERIES_COMPAT_jetson-builder-fixes = "scarthgap styhead walnascar whinlatter master"
EOF
